...
<p>python 의 round함수는 반올림함수로써, 오사오입(0.5일경우 앞의 수가 홀수면 올림, 짝수면 내림)의 규칙이 적용된다.(평균을 구하는 경우 이 방법이 오차가 적음) 이를 피하기위해 0.5를 더해준뒤 내림을 하거나, 미세한 수를 더한 후 반올림을 사용하면 된다. 이 코드는 후자를 선택했다.</p>
